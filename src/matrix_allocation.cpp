...
void MATRIX_ALLOCATION::alloc_vec(const uint32_t vector_len, std::string name, D_VECTOR &output)
{
...
void MATRIX_ALLOCATION::alloc_vec(D_VECTOR &d_vec, std::string name, S_VECTOR &s_vec)
{
...
void MATRIX_ALLOCATION::alloc_vec(const uint32_t vec_len, uint32_t num_nz, std::string name, S_VECTOR &s_vec)
{
    s_vec.vec_data.vec_name = name;
...
void MATRIX_ALLOCATION::alloc_vec(const VECTOR_INFO &vec_info, S_VECTOR &output)
{
    output.vec_data = vec_info;
    output.vec_element.reserve(vec_info.num_nz);
}

void MATRIX_ALLOCATION::alloc_vec(const VECTOR_INFO &vec_info, D_VECTOR &output)
{
    output.vec_data = vec_info;
...
void MATRIX_ALLOCATION::alloc_mat(uint32_t num_row, uint32_t num_col, std::string name, D_MATRIX &output)
{
...
void MATRIX_ALLOCATION::alloc_mat(const MATRIX_INFO &mat_info, D_MATRIX &output)
{
...
void MATRIX_ALLOCATION::alloc_mat(const MATRIX_INFO &mat_info, COO &output)
{
    output.mat_data = mat_info;
    output.mat_elements.reserve(mat_info.num_nz);
}

void MATRIX_ALLOCATION::alloc_mat(const MATRIX_INFO &mat_info, CSR &output)
{
    output.mat_data = mat_info;
...
void MATRIX_ALLOCATION::alloc_mat(const MATRIX_INFO &mat_info, CSC &output)
{
    output.mat_data = mat_info;
...
void MATRIX_ALLOCATION::delete_vec(D_VECTOR &d_vec)
{
    // d_vec.vec_data = (VECTOR_INFO){"", 0, 0};
...
void MATRIX_ALLOCATION::delete_vec(S_VECTOR &s_vec)
{
    s_vec.vec_element.clear();
    s_vec.vec_element.shrink_to_fit();
}

void MATRIX_ALLOCATION::delete_mat(D_MATRIX &d_mat)
{
...
void MATRIX_ALLOCATION::delete_mat(COO &s_mat)
{
...
void MATRIX_ALLOCATION::delete_mat(CSR &s_mat)
{
    s_mat.mat_data.matrix_name = " ";
    s_mat.mat_data.num_row = 0;
    s_mat.mat_data.num_col = 0;
...
void MATRIX_ALLOCATION::delete_mat(CSC &s_mat)
{
    s_mat.mat_data.matrix_name = " ";
    s_mat.mat_data.num_row = 0;
    s_mat.mat_data.num_col = 0;
