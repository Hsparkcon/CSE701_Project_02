#include "../include/read_dmat.hpp"

READ_DMAT::READ_DMAT() {}

READ_DMAT::~READ_DMAT() {}

bool READ_DMAT::load_dmat_ANSI_BASE(std::string file_name, D_MATRIX &output_mat)
{
    return false;
}

bool READ_DMAT::load_dmat_UNSAFE(std::string file_name, D_MATRIX &output_mat)
{
...
bool READ_DMAT::load_dmat_SAFE(std::string file_name, D_MATRIX &output_mat)
{
    return false;
}
