#include "../include/read_dvec.hpp"

READ_DVEC::READ_DVEC() {}

READ_DVEC::~READ_DVEC() {}

bool READ_DVEC::load_dvec_ANSI_BASE(std::string file_name, D_VECTOR &output_vec)
{
    FILE *load_dvec;
...
bool READ_DVEC::load_dvec_UNSAFE(std::string file_name, D_VECTOR &output_vec)
{
...
bool READ_DVEC::load_dvec_SAFE(std::string file_name, D_VECTOR &output_vec)
{
    std::ifstream load_d_vec;
    load_d_vec.open(file_name, std::ios::in);
    if (load_d_vec.is_open() == false)
