#include "../include/write_dvec.hpp"

WRITE_DVEC::WRITE_DVEC() {}

WRITE_DVEC::~WRITE_DVEC() {}

bool WRITE_DVEC::write_dvec_ANSI_based(std::string file_name, D_VECTOR &output_vec)
{
    FILE *write_dvec;
...
bool WRITE_DVEC::write_dvec_UNSAFE(std::string file_name, D_VECTOR &output_vec)
{
...
bool WRITE_DVEC::write_dvec_SAFE(std::string file_name, D_VECTOR &output_vec)
{
    std::ofstream write_dvec_file;
    write_dvec_file.open(file_name, std::ios::out);
    if (write_dvec_file.is_open() == false)
